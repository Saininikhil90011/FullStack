    ...
    <div className="recent">
      ...
      <ListGroup variant="flush">
        {posts.map((post, index) => (
          <ListGroup.Item key={index} className="d-flex align-items-center mt-2">
            <Image
              src={images[index]} // Use actual images from the array
              alt={`Image for ${post}`}
              rounded
              className="me-3"
              style={{ width: "60px", height: "60px", objectFit: "cover" }} // Styling for uniform size
            />
            <div>
